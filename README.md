...
* **holo_deck**: An autonomous AI agent workflow that watches an inbox for scenario prompts and utilizes a local Ollama instance to generate and validate fully playable JSON-driven text adventure games running in a self-contained, cyberpunk-styled HTML/JS engine.
