...
* **cyber_deck**: A cyberpunk-themed, web-based operating system UI built with FastAPI. It features a window manager, an AI terminal, and an "App Forge" that agentically writes and launches single-file HTML apps within floating windows using Ollama.
