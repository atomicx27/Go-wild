...
* **cyber_deck**: A neon cyberpunk-themed desktop OS in your browser, powered by a FastAPI backend and an Ollama agent that can dynamically generate HTML/JS/CSS widgets (like calculators or mini-games) onto your desktop upon request.
