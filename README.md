...
* **echo_cast**: An autonomous multi-agent workflow that transforms raw text files from an inbox into an interactive, multi-speaker cyberpunk audio broadcast using Ollama and the browser's native Web Speech API.
