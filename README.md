...
* **cyber_oracle**: An autonomous, cyberpunk-themed multi-agent workflow that acts as a datastream oracle. It takes a topic, breaks it down via 'The Fixer', researches sub-topics concurrently using 'Netrunners', and compiles a stylized markdown dossier via 'The Synthesizer' powered by Ollama.
