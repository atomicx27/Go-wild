...
* **nexus_automata**: An autonomous, self-building automation workflow engine that translates natural language goals into executable, multi-step code and LLM pipelines using Ollama. Features a fully-interactive cyberpunk-themed UI to visualize nodes and real-time execution logs.
